...
from NathanJamesToolbox.airtable import Airtable


airtableToolbox = Airtable  # backwards-compatibility only. Use 'Airtable' class instead.


class slackToolbox:
    def __init__(self, _key, _channel, dry_run=False):
        self._key = _key
